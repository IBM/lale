...
class TestTrainTestSplit(unittest.TestCase):
    ...
    def test_split_pandas(self):
        train, test = multitable_train_test_split(self.go_sales, main_table_name = 'go_daily_sales', test_size=0.2)
    ...
    def test_split_pandas_1(self):
        train, test = multitable_train_test_split(self.go_sales, main_table_name = 'go_daily_sales', test_size=20000)
        main_table_df: pd.Dataframe = None
        for df in test:
            if get_table_name(df) == 'go_daily_sales':
                main_table_df = df
    ...
    def test_split_spark(self):
        train, test = multitable_train_test_split(self.go_sales_spark, main_table_name = 'go_daily_sales', test_size=0.2)
        main_table_df: pd.Dataframe = None
        for df in train:
            if get_table_name(df) == 'go_daily_sales':
                main_table_df = df
