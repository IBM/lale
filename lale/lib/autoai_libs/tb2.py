...
class TB2Impl():
    def __init__(self, tans_class, name, datatypes1, feat_constraints1, datatypes2, feat_constraints2, tgraph, apply_all):
        self._hyperparams = {
...
_hyperparams_schema = {
    'allOf': [{
        ...
        'required': ['tans_class', 'name', 'datatypes1', 'feat_constraints1', 'datatypes2', 'feat_constraints2', 'tgraph', 'apply_all'],
        'relevantToOptimizer': [],
        'properties': {
            'tans_class': {
...
lale.docstrings.set_docstrings(TB2Impl, _combined_schemas)
